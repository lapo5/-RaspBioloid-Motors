...
def stand_down():
    ...
    move_all_motors(pos)
    resp1 = move_motor(13, 520, 20)
    resp1 = move_motor(14, 504, 20)
    resp1 = move_motor(15, 512, 20)
    resp1 = move_motor(16, 512, 20)
    resp1 = move_motor(11, 512, 20)
    resp1 = move_motor(12, 512, 20)
